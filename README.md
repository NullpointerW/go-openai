# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/NullpointerW/go-openaii.svg)](https://pkg.go.dev/github.com/NullpointerW/go-openaii)
[![Go Report Card](https://goreportcard.com/badge/github.com/NullpointerW/go-openaii)](https://goreportcard.com/report/github.com/NullpointerW/go-openaii)
...
```
go get github.com/NullpointerW/go-openaii
```
...
import (
	"context"
	"fmt"
	openai "github.com/NullpointerW/go-openaii"
)
...
See also: https://pkg.go.dev/github.com/NullpointerW/go-openaii#ClientConfig
</details>
...
import (
	...
	"github.com/NullpointerW/go-openaii"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/NullpointerW/go-openaii/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/NullpointerW/go-openaii/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/NullpointerW/go-openaii/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/NullpointerW/go-openaii/graphs/contributors) and sponsors of this project:
